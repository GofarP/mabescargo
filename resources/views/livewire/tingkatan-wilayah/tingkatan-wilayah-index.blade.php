<div class="card">
    ...
    <div class="d-flex flex-column align-items-end mt-3">
        ...
        <a href="{{ route('tingkatanwilayah.create') }}" class="btn btn-primary w-auto">Tambah Tingkatan Wilayah</a>
    </div>
            ...
            <tbody class="table-border-bottom-0">
                @foreach ($data_tingkatan_wilayah as $item)
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                <a href="{{ route('tingkatanwilayah.edit', $item->id) }}"
                                    class="btn btn-warning me-2">Edit</a> <!-- Add margin-end (me-2) -->
                                <form action="{{ route('tingkatanwilayah.destroy', $item->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
