<div class="card">
    ...
    <div class="d-flex flex-column align-items-end mt-3">
        ...
        <a href="{{ route('kontak.create') }}" class="btn btn-primary w-auto">Tambah Kontak</a>
    </div>
            ...
            <tbody class="table-border-bottom-0">
                @foreach ($data_kontak as $item)
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                <a href="{{route('kontak.edit',$item->id)}}" class="btn btn-warning me-2">Edit</a> <!-- Add margin-end (me-2) -->
