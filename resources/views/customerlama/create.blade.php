...
@section('title', 'Customer Lama Tambah')
@section('main-title')
    <h3>Tambah Customer Lama</h3>
@endsection
@section('content')
    <div class="card w-100">
        <div class="card-body">
            <form action="{{ route('customerlama.store') }}" method="POST">
                @csrf
                ...
                <div class="form-group mb-3">
                    ...
                    <select name="agama" id="agama" class="form-control @error('agama') is-invalid @enderror js-example-basic-single">
                ...
                <div class="form-group mb-3">
                    ...
                    <select name="wilayah_id" id="" class="form-control js-example-basic-single @error('wilayah_id') is-invalid @enderror">
