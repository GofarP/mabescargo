...
@section('title', 'Sebar Brosur Tambah')
@section('main-title')
    <h3>Tambah Sebar Brosur</h3>
@endsection
@section('content')
    <div class="card w-100">
        <div class="card-body">
            <form action="{{ route('sebarbrosur.store') }}" method="POST">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_toko" class="form-control @error('nama') is-invalid @enderror"
                        value="{{ old('nama') }}">
                    @error('nama')
                        <div class="invalid-feedback">
                            {{ $message }}
                ...
                <div class="form-group">
                    ...
                    <select name="karyawan_id" id="karyawan_id"
                        class="form-control @error('karyawan_id') is-invalid @enderror js-example-basic-single">
                ...
                <div class="form-group">
                    ...
                    <textarea name="pernah_pakai_ekspedisi" id="" cols="30" rows="10" class="form-control">{{ old('pernah_pakai_ekspedisi') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea name="nama_ekspedisi" id="" cols="30" rows="10" class="form-control">{{ old('nama_ekspedisi') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea name="kenal_mbs_cargo" id="" cols="30" rows="10" class="form-control">{{ old('kenal_mbs_cargo') }}</textarea>
