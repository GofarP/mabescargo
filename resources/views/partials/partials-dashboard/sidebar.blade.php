<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="index.html" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">Mabes Cargo</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ Str::contains(Request::path(), 'wilayah') ? 'active' : '' }}">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item {{ Request::is('tingkatanwilayah*') ? 'active' : '' }}">
                    <a href="{{ route('tingkatanwilayah.index') }}" class="menu-link">
                        <div>Tingkatan Wilayah</div>
                    </a>
                </li>
        ...
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">Cabang</span>
        </li>
        <li class="menu-item {{ Str::contains(Request::path(), 'cabang') ? 'active' : '' }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        <li class="menu-item {{ Str::contains(Request::path(), 'customer') ? 'active' : '' }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item {{ Request::is('customerlama*') ? 'active' : '' }}">
                    <a href="{{ route('customerlama.index') }}" class="menu-link">
                        <div>Data Customer Lama</div>
                    </a>
                </li>
                <li class="menu-item {{ Request::is('kategoricustomer*') ? 'active' : '' }}">
                    <a href="{{ route('kategoricustomer.index') }}" class="menu-link">
                        <div>Data Kategori Customer</div>
                    </a>
                </li>
                <li class="menu-item {{ Request::is('tipecustomer*') ? 'active' : '' }}">
                    <a href="{{ route('tipecustomer.index') }}" class="menu-link">
        ...
        <li class="menu-item  {{ Str::contains(Request::path(), 'kontak') ? 'active' : '' }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bxs-contact"></i>
                <div data-i18n="kontak">Kontak</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item {{Request::is('kontak*') ? 'active' :''}}">
        ...
        <li class="menu-item  {{ Str::contains(Request::path(), 'karyawan') ? 'active' : '' }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">Followup</span>
        </li>
        <li class="menu-item  {{ Str::contains(Request::path(), 'followup') ? 'active' : '' }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-user-circle"></i>
                <div data-i18n="followup">Followup</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item {{Request::is('followupcustomer*') ? 'active' :''}}">
                    <a href="{{ route('followupcustomer.index') }}" class="menu-link">
