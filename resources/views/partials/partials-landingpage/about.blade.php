<div class="container-fluid about py-5">
    <div class="container py-5">
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-7" style="background: linear-gradient(rgba(255, 255, 255, .8), rgba(255, 255, 255, .8)), url(/landingpage-asset/img/about-img-1.png);">
                <h5 class="section-about-title pe-3">@yield('partials-title','Tentang Kami')</h5>
                <h1 class="mb-4">Kami Adalah<span class="text-primary"> Mabes Cargo</span></h1>
